...
export function getCurrentTeacherStatus(teacher: any, targetTime: Date = new Date()): string {
  ...
  if (currentTimeInMinutes < 10 * 60 + 30) return "Off Hours (Before 10:30 AM)";
  if (currentTimeInMinutes >= 10 * 60 + 30 && currentTimeInMinutes < 11 * 60 + 30) return teacher["10:30 - 11:30"] || teacher.slot_1030_1130;
  if (currentTimeInMinutes >= 11 * 60 + 30 && currentTimeInMinutes < 12 * 60 + 30) return teacher["11:30 - 12:30"] || teacher.slot_1130_1230;
  if (currentTimeInMinutes >= 12 * 60 + 30 && currentTimeInMinutes < 13 * 60 + 30) return teacher["12:30 - 1:30"] || teacher.slot_1230_1330;
  if (currentTimeInMinutes >= 13 * 60 + 30 && currentTimeInMinutes < 14 * 60 + 30) return teacher["1:30 - 2:30"] || teacher.slot_1330_1430;
  if (currentTimeInMinutes >= 14 * 60 + 30 && currentTimeInMinutes < 15 * 60 + 30) return teacher["2:30 - 3:30"] || teacher.slot_1430_1530;
  if (currentTimeInMinutes >= 15 * 60 + 30 && currentTimeInMinutes < 16 * 60 + 30) return teacher["3:30 - 4:30"] || teacher.slot_1530_1630;
  if (currentTimeInMinutes >= 16 * 60 + 30 && currentTimeInMinutes <= 17 * 60 + 30) return teacher["4:30 - 5:30"] || teacher.slot_1630_1730;

  return "Off Hours (After 5:30 PM)";
}
